...
if (!is_admin()) {
	function register_script(){
		//wp_deregister_script('jquery'); //既存jqueryの非表示
		//wp_register_script('jquery-js', 'https://ajax.googleapis.com/ajax/libs/jquery/2.1.4/jquery.min.js', false, '1.0', true);
		//自動住所入力を設置
...
function custom_login() {
	$files = '<link rel="stylesheet" href="'.get_template_directory_uri().'/lib/css/user_admin.css" />';
	echo $files;
}
...
function add_admin_css() {
	...
	$css = '<link rel="stylesheet" type="text/css" href="' . $dir . '/lib/css/user_admin.css" />' . "\n";
	$output = $css. $js;
	echo $output;
}
